...
var NewPowerFactor = /** @class */ (function (_super) {
    ...
    function NewPowerFactor(props, state) {
        ...
        _this.FloorhandleAddRow = function () {
            //alert($('#OutdoorPowerInput').val());
            var status = true;
            var arrayIndex = _this.state.arrayIndex;
            var trIndex = $("#ManuallTable").find("tr").last();
            if (status == true && trIndex.find("[id*='QuantityNo']").val() != '' && trIndex.find("[id*='Total']").val() != NaN && trIndex.find("td").eq(1).text() != "Model" && trIndex.find("td").eq(0).text() != "Select") {
                ...
                arrayIndex += 1;
                //setTimeout(() => {
                _this.getTableFloor(arrayIndex);
                //}, 1000);
            }
            else {
                $("#AlertModel").show();
        ...
        _this.handleChangeFloorPf = function (selectedOptions2, SelectedFloor) {
        ...
        _this.AddListItems2 = function (MasterId) {
            ...
            for (var i = 0; i < bindModel.length; i++) {
                ...
                var newweb = Web("https://taqeef.sharepoint.com/sites/OPR/ACModel");
        ...
        _this.ShowSubject = function () {
            if (_this.state.ToLeft == true && _this.state.SubLeft == true) {
                ...
                else if (_this.state.Floor == true) {
                    $("#SubjectManually").show();
                    $("#SubjectButton").hide();
                    _this.setState({ ModLeft: true });
                    _this.setState({ NoteLeft: false });
        ...
        _this.SaveFloor = function () {
            if (_this.SaveInvoFloorValidation()) {
                savearr2 = [];
                savearr3 = [];
                var x = document.getElementsByClassName("banner home-banner powerfactor-banner relative");
                x[0].className = 'banner open home-banner powerfactor-banner relative';
                ...
                _this.setState({ SelectedInvo: Invorder });
                // alert(Invorder);
                //$('#DynamicRow tr').empty();
                //$('#DynamicRow').empty();
                _this.displayModel = [];
    ...
    NewPowerFactor.prototype.getTable2 = function (arrayIndex) {
        ...
        reactHandler.displayData.push(React.createElement("tr", { className: arrayIndex + "-tablerow" },
            React.createElement("td", null,
                " ",
                React.createElement(Select, { id: "Brand", options: options, theme: function (theme) { return (__assign({}, theme, { borderRadius: 0, colors: __assign({}, theme.colors, { primary25: 'white', primary: 'white' }) })); }, isClearable: true, isSearchable: true, placeholder: "Brand", onChange: reactHandler.GetModelTypes })),
            React.createElement("td", null,
                React.createElement(Select, { id: "Model", options: ManualBrand, theme: function (theme) { return (__assign({}, theme, { borderRadius: 0, colors: __assign({}, theme.colors, { primary25: 'white', primary: 'white' }) })); }, isClearable: true, isSearchable: true, placeholder: "Model", onChange: reactHandler.handleChangePf })),
            React.createElement("td", null,
    ...
    NewPowerFactor.prototype.GetFloorLocation = function () {
        var reactHandler = this;
        $.ajax({
    ...
    NewPowerFactor.prototype.GetFloor = function (SelectedFloor) {
    ...
    NewPowerFactor.prototype.getTableFloor = function (arrayIndex) {
        var reactHandler = this;
        reactHandler.setState({ arrayIndex: arrayIndex });
        var selectedOptions2 = reactHandler.state.selectedOptions2;
        var SelectedFloor = reactHandler.state.SelectedFloor;
        var value1 = selectedOptions2;
        reactHandler.displayData.push(React.createElement("tr", { className: arrayIndex + "-tablerow" },
            React.createElement("td", null,
                " ",
                React.createElement(Select, { id: "Floor", options: FloorArr, theme: function (theme) { return (__assign({}, theme, { borderRadius: 0, colors: __assign({}, theme.colors, { primary25: 'white', primary: 'white' }) })); }, isClearable: true, isSearchable: true, placeholder: "Floor", onChange: reactHandler.GetFloor })),
            React.createElement("td", null,
                " ",
                React.createElement(Select, { id: "Brand", options: options, theme: function (theme) { return (__assign({}, theme, { borderRadius: 0, colors: __assign({}, theme.colors, { primary25: 'white', primary: 'white' }) })); }, isClearable: true, isSearchable: true, placeholder: "Brand", onChange: reactHandler.GetModelTypes })),
            React.createElement("td", null,
                React.createElement(Select, { id: "Model", options: ManualBrand, theme: function (theme) { return (__assign({}, theme, { borderRadius: 0, colors: __assign({}, theme.colors, { primary25: 'white', primary: 'white' }) })); }, isClearable: true, isSearchable: true, placeholder: "Model", onChange: reactHandler.handleChangeFloorPf })),
            React.createElement("td", null,
                React.createElement("input", { type: "text", id: "QuantityNo", onChange: function () { return reactHandler.GetQuantitytotal(arrayIndex); } })),
            React.createElement("td", null,
                React.createElement("input", { type: "text", id: "RatedCapacity" })),
    ...
    NewPowerFactor.prototype.GetProfile = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        newweb = Web("https://taqeef.sharepoint.com/sites/OPR");
    ...
    NewPowerFactor.prototype.SaveManuallyList = function (ReceiverId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        newweb = Web("https://taqeef.sharepoint.com/sites/OPR/ACModel");
    ...
    NewPowerFactor.prototype.SaveInvoFloorValidation = function () {
        var status = true;
    ...
    NewPowerFactor.prototype.render = function () {
        ...
        return (React.createElement("div", { className: styles.newPowerFactor },
                    ...
                    React.createElement("div", { className: "container" },
                        React.createElement("div", { className: "banner-contents" },
                            ...
                            React.createElement("div", { className: "row pf-defaultcontrols" },
                                React.createElement("div", { className: "col-md-6" },
                                    React.createElement("div", { className: "form-group relative" },
                                        ...
                                        React.createElement(Select, { id: "Search", options: uniquearr1, onInputChange: this.handleInputChange, theme: function (theme) { return (__assign({}, theme, { borderRadius: 0, colors: __assign({}, theme.colors, { primary25: 'white', primary: 'white' }) })); }, isClearable: true, isSearchable: true, placeholder: "Search for Invoice No", value: value, onChange: this.handleChange }))),
                                React.createElement("div", { className: "col-md-6" },
                                    React.createElement("div", { className: "form-group relative" },
                                        React.createElement("img", { src: "https://taqeef.sharepoint.com/sites/OPR/ACModel/SiteAssets/img/img/search.svg", alt: "search" }),
                                        React.createElement(Select, { id: "Search", options: uniquearr, onInputChange: this.handleInputChange, theme: function (theme) { return (__assign({}, theme, { borderRadius: 0, colors: __assign({}, theme.colors, { primary25: 'white', primary: 'white' }) })); }, isClearable: true, isSearchable: true, placeholder: "Search for Order No", value: value, onChange: this.handleChange3 }))),
                            ...
                            React.createElement("div", { className: "row pf-createmanually" },
                                ...
                                React.createElement("div", { className: "col-md-4" },
                                    React.createElement("div", { className: "form-group relative" },
                                        React.createElement("input", { type: "submit", className: "btn btn-primary", value: "Floor-By-Floor", onClick: function () { return _this.ShowFloor(); } }))),
                        ...
                        React.createElement("div", { className: "main-textareas" },
                            ...
                            React.createElement("div", { id: "ModelManually", className: "space-separator clearfix container-outdoor-pv" },
                                ...
                                React.createElement("button", { id: "add-row", onClick: this.handleAddRow },
                                    ...
                                    " Add")),
                            React.createElement("div", { id: "FloorModelManually", className: "space-separator clearfix container-outdoor-pv" },
                                React.createElement("table", { className: "table", id: "FloorManuallTable" },
                                    React.createElement("thead", null,
                                        React.createElement("tr", null,
                                            React.createElement("th", { className: "model-td", rowSpan: 2 }, " Floor "),
                                            React.createElement("th", { className: "model-td", rowSpan: 2 }, " Brand "),
                                            React.createElement("th", { className: "model-td", rowSpan: 2 }, " Model "),
                                            React.createElement("th", { rowSpan: 2 }, " Quantity "),
                                            React.createElement("th", { rowSpan: 2 },
                                        ...
                                        React.createElement("tr", null,
                                            ...
                                            React.createElement("th", null,
                                                ...
                                                "  "))),
                                    React.createElement("tbody", null, this.state.showdata)),
                                React.createElement("button", { id: "add-row", onClick: this.FloorhandleAddRow },
                                    React.createElement("i", { className: "fa fa-plus", "aria-hidden": "true" }),
                                    " Add")),
            ...
            React.createElement("div", { id: "ManuallyFloor" },
                React.createElement("div", { className: "lightbox open" },
                    React.createElement("div", { className: "lightbox-inner-contents" },
                        React.createElement("div", { className: "lightbox-title" }, "Create Floor-By-Floor"),
                        React.createElement("div", { className: "lightbox-body" },
                            React.createElement("div", { className: "form-group" },
                                React.createElement("div", { className: "row" },
                                    React.createElement("div", { className: "col-md-3" },
                                        React.createElement("label", null, "  Invoice/OrderNo ")),
                                    React.createElement("div", { className: "col-md-9" },
                                        React.createElement("input", { type: "text", id: "FloorInvord", className: "form-control" }),
                                        React.createElement("span", { id: "InvoError", style: { display: "none", color: "red" } }, "Enter InvoiceNo/orderNo to continue")))),
                            React.createElement("div", { className: "row" },
                                React.createElement("div", { className: "col-md-12 text-center m-b-10" },
                                    React.createElement("input", { type: "submit", className: "btn btn-primary", id: "SaveButton", onClick: function () { return _this.SaveFloor(); }, value: "Save" }),
                                    React.createElement("input", { type: "submit", className: "btn btn-no-bg", onClick: function () { return _this.HideManually(); }, value: "Cancel" }))))))),
...
export default NewPowerFactor;
//# sourceMappingURL=NewPowerFactor.js.map