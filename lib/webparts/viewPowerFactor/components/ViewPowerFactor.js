...
var ViewPowerFactor = /** @class */ (function (_super) {
        ...
        if (savearr.length != 0) {
            ...
            autoTable(doc_1, {
                ...
                didDrawPage: function (data) {
                    ...
                    if (reactHandler.state.SalesPersonCode.length == 3) {
                        doc_1.setFontSize(8);
                        doc_1.text('Pf–', 168, 30);
                        doc_1.setFontSize(8);
                        doc_1.text(reactHandler.state.SalesPersonCode, 172, 30);
                        doc_1.setFontSize(8);
                        doc_1.text('/', 179, 30);
                        doc_1.setFontSize(8);
                        ...
                        doc_1.setFontSize(8);
                        doc_1.text('Pf–', 167, 30);
                        doc_1.setFontSize(8);
                        doc_1.text(reactHandler.state.SalesPersonCode, 171, 30);
                        doc_1.setFontSize(8);
                        doc_1.text('/', 179, 30);
                        doc_1.setFontSize(8);
                        doc_1.text(reactHandler.state.SelectedInvo, 180, 30);
                        ...
                        doc_1.setFontSize(8);
                        doc_1.text('Pf–', 165, 30);
                        doc_1.setFontSize(8);
                        doc_1.text(reactHandler.state.SalesPersonCode, 169, 30);
                        doc_1.setFontSize(8);
                        doc_1.text('/', 179, 30);
                        doc_1.setFontSize(8);
                        doc_1.text(reactHandler.state.SelectedInvo, 180, 30);
                        ...
                        doc_1.setFontSize(8);
                        doc_1.text('Pf–', 163, 30);
                        doc_1.setFontSize(8);
                        doc_1.text(reactHandler.state.SalesPersonCode, 168, 30);
                        doc_1.setFontSize(8);
                        doc_1.text('/', 182, 30);
                        doc_1.setFontSize(8);
                        doc_1.text(reactHandler.state.SelectedInvo, 185, 30);
                        doc_1.setFontSize(8);
                        doc_1.text('/001', 202, 30);
                    }
                    else if (reactHandler.state.SalesPersonCode.length == 7) {
                        doc_1.setFontSize(8);
                        doc_1.text('Pf–', 161, 30);
                        doc_1.setFontSize(8);
                        doc_1.text(reactHandler.state.SalesPersonCode, 165, 30);
                        doc_1.setFontSize(8);
                        doc_1.text('/', 179, 30);
                        doc_1.setFontSize(8);
                        doc_1.text(reactHandler.state.SelectedInvo, 180, 30);
            ...
            autoTable(doc_2, {
                ...
                didDrawPage: function (data) {
                    ...
                    if (reactHandler.state.SalesPersonCode.length == 3) {
                        doc_2.setFontSize(8);
                        doc_2.text('Pf–', 168, 30);
                        doc_2.setFontSize(8);
                        doc_2.text(reactHandler.state.SalesPersonCode, 172, 30);
                        doc_2.setFontSize(8);
                        doc_2.text('/', 179, 30);
                        doc_2.setFontSize(8);
                        ...
                        doc_2.setFontSize(8);
                        doc_2.text('Pf–', 167, 30);
                        doc_2.setFontSize(8);
                        doc_2.text(reactHandler.state.SalesPersonCode, 171, 30);
                        doc_2.setFontSize(8);
                        doc_2.text('/', 179, 30);
                        doc_2.setFontSize(8);
                        doc_2.text(reactHandler.state.SelectedInvo, 180, 30);
                        ...
                        doc_2.setFontSize(8);
                        doc_2.text('Pf–', 165, 30);
                        doc_2.setFontSize(8);
                        doc_2.text(reactHandler.state.SalesPersonCode, 169, 30);
                        doc_2.setFontSize(8);
                        doc_2.text('/', 179, 30);
                        doc_2.setFontSize(8);
                        doc_2.text(reactHandler.state.SelectedInvo, 180, 30);
                        ...
                        doc_2.setFontSize(8);
                        doc_2.text('Pf–', 163, 30);
                        doc_2.setFontSize(8);
                        doc_2.text(reactHandler.state.SalesPersonCode, 168, 30);
                        doc_2.setFontSize(8);
                        doc_2.text('/', 182, 30);
                        doc_2.setFontSize(8);
                        doc_2.text(reactHandler.state.SelectedInvo, 185, 30);
                        doc_2.setFontSize(8);
                        doc_2.text('/001', 202, 30);
                    }
                    else if (reactHandler.state.SalesPersonCode.length == 7) {
                        doc_2.setFontSize(8);
                        doc_2.text('Pf–', 161, 30);
                        doc_2.setFontSize(8);
                        doc_2.text(reactHandler.state.SalesPersonCode, 165, 30);
                        doc_2.setFontSize(8);
                        doc_2.text('/', 179, 30);
                        doc_2.setFontSize(8);
                        doc_2.text(reactHandler.state.SelectedInvo, 180, 30);
    ...
    ViewPowerFactor.prototype.render = function () {
        ...
        return (React.createElement("div", { className: styles.viewPowerFactor },
...
export default ViewPowerFactor;
//# sourceMappingURL=ViewPowerFactor.js.map